...
const accountTw = 'ThePracticalDev';
...
const SCHeader = ({
  isMobile, header, account, date, handleClick, headLine,
}) => (
  <MobileSize isMobile={isMobile}>
    <HrStyle />
    <MarginStyle isMobile={isMobile}>
      <SCHeaderImgStyle isMobile={isMobile} src="https://pbs.twimg.com/profile_images/1002604104194056192/IEoNsLNM_400x400.jpg" alt="profile" />
      <div>
        <div>
        ...
        <MobileTextHeader isMobile={isMobile}>
          ...
          <div>
            {'{ cred:'}
            {' '}
            <AncoreStyle href={`https://www.twitter.com/${accountTw}`}>{accountTw}</AncoreStyle>
            {' }'}
          </div>
        </MobileTextHeader>
      </div>
